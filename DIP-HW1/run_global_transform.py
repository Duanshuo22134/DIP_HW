...
def apply_transform(image, scale, rotation, translation_x, translation_y, flip_horizontal):
    """
    Applies a combination of transformations (scaling, rotation, translation, and horizontal flip) to the input image based on user inputs from the Gradio interface.
    The transformations are applied in the following order:
    1. Scaling and Rotation (around the center of the image)
    2. Translation
    3. Horizontal Flip (if selected)
